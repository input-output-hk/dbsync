...
writeSyncStateStmt =
  ...
  where
    sql = T.concat
      ...
      , ", epoch_param_id_counter          = $32"
      , ", epoch_state_id_counter          = $33"
      , ", cost_model_id_counter           = $34"
      , ", pot_transfer_id_counter         = $35"
      , ", treasury_id_counter             = $36"
      , ", reserve_id_counter              = $37"
      , ", schema_version_applied          = $38"
      , ", ledger_enabled                  = $39"
      , ", updated_at                      = now()"
      , " WHERE id = 1"
      ]

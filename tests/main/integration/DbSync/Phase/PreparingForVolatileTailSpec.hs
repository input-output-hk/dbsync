...
-- | End-to-end tests for 'DbSync.Phase.PreparingForVolatileTail.run'.
--
...
--
-- After the pipeline drains, 'Phase.PreparingForVolatileTail.run'
...
module DbSync.Phase.PreparingForVolatileTailSpec (spec) where
...
spec :: Spec
spec = describe "DbSync.Phase.PreparingForVolatileTail" $
  beforeAll_ setUp $

...
-- | Pure tests for 'DbSync.Ingest.Consumer'.
...
rollbackBoundarySpec = describe "DbSync.Ingest.Consumer.rollbackBoundaryReached" $ do
...
ingestRollbackPanicSpec = describe "DbSync.Ingest.Consumer.ingestRollbackPanicMessage" $ do
